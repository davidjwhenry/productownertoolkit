...
```
notion-fetch: { "id": "https://www.notion.so/{page-id}" }
```
...
**Store returned URLs:** e.g., `EP-52 → https://www.notion.so/{page-id}`
...
| Epic | Notion URL |
| --- | --- |
| EP-52: Investment Marketing and Discovery | https://www.notion.so/{page-id} |
| EP-53: Product Information Screen | https://www.notion.so/{page-id} |
| EP-54: Investment Purchase Flow | https://www.notion.so/{page-id} |
| EP-55: Investment Portfolio Dashboard | https://www.notion.so/{page-id} |
| EP-56: Early Redemption | https://www.notion.so/{page-id} |
| EP-57: Investment Product Configuration | https://www.notion.so/{page-id} |
...
| US-54.1: Review and Legal Agreements | {Assignee} | https://www.notion.so/{page-id} |
| US-54.2: Account Opening and Fund Transfer | {Assignee} | https://www.notion.so/{page-id} |
| US-54.3: Investment Confirmation | {Assignee} | https://www.notion.so/{page-id} |
| US-55.1: Portfolio Summary | {Assignee} | https://www.notion.so/{page-id} |
| US-55.2: Coupons and Transactions | {Assignee} | https://www.notion.so/{page-id} |
| US-55.3: Portfolio Allocation | {Assignee} | https://www.notion.so/{page-id} |
| US-56.1: Redemption Flow | {Assignee} | https://www.notion.so/{page-id} |
| US-56.2: Redemption Confirmation | {Assignee} | https://www.notion.so/{page-id} |
| US-57.1: Product Config Table | Abhinav Singh | https://www.notion.so/{page-id} |
| US-57.2: Pool Capacity Management | Abhinav Singh | https://www.notion.so/{page-id} |
