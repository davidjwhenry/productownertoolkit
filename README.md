...
A toolkit for Product Owners and PMs who want AI to do more of the heavy lifting across research, requirements, backlog creation, documentation, and stakeholder communication, without giving up the judgement that makes the work good.

This repo is shaped by practical use, not theory. I've been using a similar setup to write requirements and run research for an AI-native digital bank, and this toolkit is where I'm distilling those learnings into a reusable way of working. The goal is simple: help product people move beyond one-off prompts and scattered "deep research" into a more disciplined system for producing better artefacts, faster.
